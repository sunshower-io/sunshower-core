...
import io.sunshower.service.security.JpaCredentialService;
...
public class CoreServiceConfiguration {
    ...
    @Bean
    public MOXyJsonGraphContext moXyJsonGraphContext(DynamicResolvingMoxyJsonProvider provider, DynamicJaxrsProviders providers) {
    ...
    @Bean(name = OrchestrationTemplateService.NAME)
    public OrchestrationTemplateService orchestrationTemplateService() {
        return new JpaOrchestrationTemplateService();
    }
