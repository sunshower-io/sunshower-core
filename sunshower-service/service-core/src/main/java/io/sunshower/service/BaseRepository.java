...
public abstract class BaseRepository<
    ...
    @Inject
    private PermissionsService<Permission> permissionService;
    ...
    public E delete(ID id) {
        ...
        if (entity == null) {
            throw new EntityNotFoundException(String
                    .format("No %s " +
                            "identified by '%s' was found for current user!",
                            entityType, id
                    ));
        }
        ...
        final String template =
                String.format(
                        "select count(e) from %s as e " +
                                ...
                                "and e.id = :wid", entityName
                );
        final Long w = entityManager.createQuery(
                template, Long.class
    ...
    protected TypedQuery<E> listQuery() {
        ...
        final String template =
                "select e from %s e " +
                        "join e.identity oid where " +
                        "oid.owner.username = :id";
