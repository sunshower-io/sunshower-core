 ...
 */
@Task(
        key = "io::sunshower::tertiary-task",
        definition = TertiaryNode.class
)
public class TertiaryDependent {

    @Context
    private TertiaryNode node;

    @Context
    private String name;

    @Context
    private SampleNode ancestor;

    @Context
    private SuccessorSampleNode predecessor;
