...
public abstract class ServiceTestCase extends SerializationTestCase {
  ...
  @Inject protected FullTextEntityManager fullTextEntityManager;

  @Inject protected PlatformTransactionManager platformTransactionManager;
  ...
  protected <T> T save(T value) {
    final EntityManager transactionEntityManager = entityManagerFactory.createEntityManager();
