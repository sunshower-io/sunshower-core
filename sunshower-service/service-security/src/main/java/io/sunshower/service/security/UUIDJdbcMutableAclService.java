...
@Transactional
public class UUIDJdbcMutableAclService extends JdbcAclService implements MutableAclService {
    // ~ Instance fields
    // ================================================================================================
...
//	private String sidIdentityQuery = "call identity()";
    ...
    public UUIDJdbcMutableAclService(DataSource dataSource, LookupStrategy lookupStrategy,
                                     AclCache aclCache) {
    ...
    protected UUID createOrRetrieveClassPrimaryKey(String type, boolean allowCreate) {
        List<UUID> classIds = jdbcTemplate.queryForList(selectClassPrimaryKey,
                new Object[]{type}, UUID.class);
        ...
        if (allowCreate) {
            ...
            jdbcTemplate.update(insertClass, id, type);
...
//			return jdbcTemplate.queryForObject(classIdentityQuery, UUID.class);
     ...
     * @return the primary key or null if not found
     */
    protected UUID createOrRetrieveSidPrimaryKey(String sidName, boolean sidIsPrincipal,
                                                 boolean allowCreate) {

        List<UUID> sidIds = jdbcTemplate.queryForList(selectSidPrimaryKey, new Object[]{
                Boolean.valueOf(sidIsPrincipal), sidName}, UUID.class);
        ...
        if (allowCreate) {
            ...
            jdbcTemplate.update(
                    insertSid,
                    id,
                    Boolean.valueOf(sidIsPrincipal),
                    sidName
            );
            Assert.isTrue(TransactionSynchronizationManager.isSynchronizationActive(),
                    "Transaction must be running");
...
//			return jdbcTemplate.queryForObject(sidIdentityQuery, UUID.class);
    ...
    protected UUID retrieveObjectIdentityPrimaryKey(ObjectIdentity oid) {
        ...
        try {
            return jdbcTemplate.queryForObject(selectObjectIdentityPrimaryKey, UUID.class,
