...
public class SpringPermissionsService implements PermissionsService<Permission> {
    ...
    @Override
    public <T extends Persistable> void grantWithCurrentSession(Class<T> type, T instance, Permission... permissions) {
    ...
    @Override
    public <T extends ProtectedDistributableEntity> void checkPermission(T instance, Permission... permissions) {
    ...
    @Override
    public <T extends Persistable> void revokeOnCurrentSession(Class<T> type, T instance, Permission... permissions) {
