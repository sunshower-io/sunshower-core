...
public class ConnectionDetectingJDBCTemplate extends JdbcTemplate {
   ...
   * @see #setDataSource
   */
  public ConnectionDetectingJDBCTemplate() {}
   ...
   */
  public ConnectionDetectingJDBCTemplate(DataSource dataSource) {
   ...
   */
  public ConnectionDetectingJDBCTemplate(DataSource dataSource, boolean lazyInit) {
    setDataSource(dataSource);
   ...
   * @param updateCountParameters Parameter list of declared update count parameters for the stored
   *     procedure
   * @param resultSetParameters Parameter list of declared resultSet parameters for the stored
   *     procedure
